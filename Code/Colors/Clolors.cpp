...
int main()
{
    ...
    Shader lightCubeShader("1.light_cube.vs", "1.light_cube.fs");   // 代表光源的立方体
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 激活着色器
        lightingShader.use();
        lightingShader.setVec3("objectColor", 1.0f, 0.5f, 0.31f);   // 物体颜色为珊瑚红
        lightingShader.setVec3("lightColor", 1.0f, 1.0f, 1.0f);     // 光源颜色为白色
