...
int main()
{
    ...
    Shader lightCubeShader("3.1.light_cube.vs", "3.1.light_cube.fs");   // 代表光源的立方体
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec3 diffuseColor = lightColor * glm::vec3(0.5f);   // 降低光源漫反射影响 0.5
        glm::vec3 ambientColor = diffuseColor * glm::vec3(0.2f); // 很低的环境光照的影响 0.2
        lightingShader.setVec3("light.ambient", ambientColor);
        lightingShader.setVec3("light.diffuse", diffuseColor);
        lightingShader.setVec3("light.specular", 1.0f, 1.0f, 1.0f);

        // 材质初始化填充
        lightingShader.setVec3("material.ambient", 1.0f, 0.5f, 0.31f);  // 环境光照设置为我们想要物体拥有的颜色
        lightingShader.setVec3("material.diffuse", 1.0f, 0.5f, 0.31f);  // 漫反射设置为我们想要物体拥有的颜色
